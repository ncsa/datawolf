...
import edu.illinois.ncsa.datawolf.tool.creator.commandline.CommandLineWizard;
...
public class ToolCreator extends JFrame {
    ...
    public ToolCreator() {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!txtURL.getText().trim().equals("") && (person != null)) {
                    CommandLineWizard wizard = new CommandLineWizard(ToolCreator.this, "DataWolf Command Line Wizard");
                    if (wizard.open()) {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!txtURL.getText().trim().equals("") && (person != null)) {
                    JavaWizard wizard = new JavaWizard(ToolCreator.this, "DataWolf Java Wizard");
                    if (wizard.open()) {
                        wizard.createTool(txtURL.getText().trim(), person);
                    }
                }
